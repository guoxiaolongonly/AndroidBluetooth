...
import com.standard.bluetoothmodule.dataprocess.DataProcessHandler;
...
public class BluetoothTransferService {
    ...
    public void setFileCachePath(File file) {
        cacheFilePath = file;
    }
    ...
    public synchronized void connect(BluetoothDevice device, boolean secure) {
        ...
        // Cancel any thread currently accept
        if (mSecureAcceptThread != null) {
    ...
    public void writeNormalCommand(byte modular, byte function, File data) {
    }

    /**
     * 等待连接(如果作为主动连接端可以不开启这个线程)
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED && mAdapter.isEnabled() && mmServerSocket != null) {
                try {
    ...
    private class ConnectedThread extends Thread {
        ...
        public ConnectedThread(BluetoothSocket socket, String socketType) {
            ...
            dataProcessHandler = new DataProcessHandler(mHandler);
        }
        ...
        public void write(byte[] datas) {
            try {
                Log.d("Write", System.currentTimeMillis() + "");
                mmOutStream.write(datas);
                mHandler.obtainMessage(Constants.MESSAGE_WRITE, -1, -1, datas)
                        .sendToTarget();
            } catch (IOException e) {
